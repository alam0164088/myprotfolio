...
SECRET_KEY = 'django-insecure-n!i9d+ieq99@%81=(dh(3mw%42x)n3a_(c2%u20_bkq0pn2h0)'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'core' / 'templates',  # Path to core app's templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'core' / 'static',  # Correct path to core/static/ folder
]
